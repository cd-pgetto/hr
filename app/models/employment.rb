...
class Employment < ApplicationRecord
  ...
  enum :employment_type, {employee: "employee", contractor: "contractor"}

  validates :employment_type, presence: true
  validates :person_id, uniqueness: {scope: :company_id, if: :employee?,
                                     message: "can have only one employment per company as an employee"}
end
